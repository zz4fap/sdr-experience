...
segments_to_check = [55 57 59 63 66 70 72 74];

counter = 0;
pfa_vs_pd = zeros(2,length(-30:1:30));

dbW = 0; % in dbW 

SNR = 0; % in dB -- For this simulation the SNR is equal to 0 dB.

for desired_pfa=0.00001:0.000001:0.1
    ...
    filename = sprintf('pfa_vs_achieved_pd_%d.mat',desired_pfa);
    save(filename, 'desired_pfa','detection_rate','false_rejection_rate','SNR');
    
    counter = counter + 1;
    pfa_vs_pd(:,counter) = [desired_pfa;detection_rate];
end
