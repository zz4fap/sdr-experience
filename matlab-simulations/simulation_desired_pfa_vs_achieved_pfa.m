...
dbW = 0; % in dbW -- For this simulation the noise power is equal to 0 dbW.
...
for desired_pfa=0.00001:0.000001:0.1
    ...
    filename = sprintf('desired_pfa_vs_achieved_pfa_%d.mat',desired_pfa);
    save(filename, 'desired_pfa','false_alarm_rate','correct_rejection_rate','dbW');
    
    counter = counter + 1;
    pfa_vs_dbW(:,counter) = [desired_pfa;false_alarm_rate];
end
